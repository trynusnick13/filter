...
from filter_app.filters.negative_filter import NegativeFilter
import PIL
...
class NegativeCommand(ConcreteCommand):
    ...
    def execute(self, new_image=None):
        ...
        negative_filter = NegativeFilter(image=self.image, name_of_filter='change brightness command' + self.image.name)
...
if __name__ == '__main__':
    ...
    test_image = NegativeCommand(base_image).execute()
